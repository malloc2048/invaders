#ifndef INVADERS_XRA_H
#define INVADERS_XRA_H

#include "instruction.h"

class XRA: public Instruction {
public:
    XRA() = delete;
    ~XRA() = default;
    XRA(cabinet::Flags& flags, cabinet::Memory& memory, Registers& registers): Instruction(flags, memory, registers){}
