...
public:
    SBI() = delete;
    ~SBI() = default;
    SBI(cabinet::Flags& flags, cabinet::Memory& memory, Registers& registers): Instruction(flags, memory, registers){}

    void Execute(uint8_t opcode) override {
        uint16_t diff = registers.a - memory.read_byte(registers.pc.d16) - flags.carry;
