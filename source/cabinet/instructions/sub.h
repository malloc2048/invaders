...
public:
    SUB() = delete;
    ~SUB() = default;
    SUB(cabinet::Flags& flags, cabinet::Memory& memory, Registers& registers): Instruction(flags, memory, registers){}
    ...
    void Execute(uint8_t opcode) override {
        ...
        switch(src) {
            ...
            case L:
                ...
                break;
            case M:
                diff = registers.a - memory.read_byte(registers.hl.d16);
                break;
            case A:
