#ifndef EMULATOR_INR_H
#define EMULATOR_INR_H
...
public:
    ...
    INR(Memory* ramIn, Flags* flagsIn, Registers* registersIn) {
        ram = ramIn;
        flags = flagsIn;
