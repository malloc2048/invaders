#ifndef EMULATOR_SBB_H
#define EMULATOR_SBB_H
...
public:
    SBB() = delete;
    ~SBB() = default;
    SBB(Memory* ramIn, Flags* flagsIn, Registers* registersIn) {
        ram = ramIn;
        flags = flagsIn;
    ...
    void Disassemble(std::ostream& out) override {
        ...
        out << (unsigned)ram->read(registers->pc.d16) << "\tSBB " << registerNames[src];
        registers->pc.d16 += 1;
