...
namespace decrement {
    ...
    void DCX_B(Regs &registers) { machine::Unimplemented(registers); }
    void DCX_D(Regs &registers) { machine::Unimplemented(registers); }
    void DCX_H(Regs &registers) { machine::Unimplemented(registers); }
    void DCX_SP(Regs &registers) { machine::Unimplemented(registers); }
}
